...
local colour1={ {0, 0xE05700, 1}, {0.5, 0xFFD145, 1}, {1, 0xE05700, 1} }    -- orange
local colour2={ {0, 0x003E00, 1}, {0.5, 0x03F404, 1}, {1, 0x003E00, 1} }    -- green
local colour3={ {0, 0x10000ba, 1}, {0.5, 0x8cc7ff, 1}, {1, 0x0000ba, 1} }   -- blue
local colour4={ {0, 0x2b2b2b, 1}, {0.5, 0xa3a3a3, 1}, {1 ,0x2b2b2b, 1} }    -- black
local colour5={ {0, 0x5c0000, 1}, {0.5, 0xff0000, 1}, {1 ,0x5c0000, 1} }    -- red

local bgcolour1={ {1, 0x000000, 0.5} }  -- black
local bgcolour2={ {1, 0x0000ba, 0.5} }  -- blue
