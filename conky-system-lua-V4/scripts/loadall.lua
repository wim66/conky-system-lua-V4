...
if not success then
    print("Error loading background module: "..background)
end

local success, lua1_graphs = pcall(require, 'lua1-graphs')
if not success then
    print("Error loading lua1-graphs module: "..lua1_graphs)
end

local success, lua2_text = pcall(require, 'lua2-text')
if not success then
    print("Error loading lua2-text module: "..lua2_text)
end

local success, lua3_bars = pcall(require, 'lua3-bars')
if not success then
    print("Error loading lua3-bars module: "..lua3_bars)
end
